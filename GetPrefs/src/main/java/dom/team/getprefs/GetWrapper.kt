package dom.team.getprefs

import android.content.Context
import android.content.SharedPreferences
import dom.team.getprefs.`interface`.Wrapper
import dom.team.getprefs.wrappers.PrefsEncrypter
import dom.team.getprefs.wrappers.PrefsWrapper

class GetWrapper(context: Context, auth: Pair<String, String>, shouldEncrypt: Boolean) {
