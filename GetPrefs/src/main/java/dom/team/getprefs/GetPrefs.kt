...
class GetPrefs(context: Context, fileName: String, key: String, shouldEncrypt: Boolean = true) {

    internal val preferences = GetWrapper(context, fileName to key, shouldEncrypt)
